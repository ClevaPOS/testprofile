...
<div class="pane-pane <?php print $classes; ?> <?php print (isset($settings['top_color'])) ? $settings['top_color']: 'pane-nostyle'; ?>">
	<?php if(isset($content->title)): ?>
		<h2 class="<?php print (isset($settings['top_color'])) ? $settings['top_color']:'' ; ?>"><?php print $content->title; ?></h2>
